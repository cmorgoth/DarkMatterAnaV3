...
int RatioPlotsV3(TH1F* h1, TH1F* h2, TString h1Name = "h1Name", TString h2Name = "h2Name", TString fname = "default_name", TString type = "defaultType", int nbins = 0, double xl = 0, double xh = 0, TLegend* leg = NULL){
  ...
  TString label;
  if(type == "MR"){
    RATIO = new TH1F("RATIO", fname + "_" + type , nbins, xl, xh);
    label = "M_{R}";
    h1->GetXaxis()->SetRangeUser(xl,xh);
    h2->GetXaxis()->SetRangeUser(xl,xh);
    RATIO->GetXaxis()->SetRangeUser(xl,xh);
...
int RatioPlotsV2(THStack* s, TH1F* h2, TH1F* h1, TString h1Name = "h1Name", TString h2Name = "h2Name", TString fname = "default_name", TString type = "defaultType", TLegend* le = NULL){
  ...
  if(type == "MR"){
    //RATIO = new TH1F("RATIO", fname + "_" + type , BaseDM::MR_Bins, BaseDM::MR_BinArr);
    RATIO = new TH1F("RATIO", fname + "_" + type , 20, 200.0, 1700.0); 
    label = "M_{R}";
    //h1->GetXaxis()->SetRangeUser(200.,3500.);
    //h2->GetXaxis()->SetRangeUser(200.,3500.);
    //RATIO->GetXaxis()->SetRangeUser(200.,3500.);
    
    h1->GetXaxis()->SetRangeUser(200., 1700.);
    h2->GetXaxis()->SetRangeUser(200., 1700.);
    RATIO->GetXaxis()->SetRangeUser(200., 1700.);
    RATIO->GetYaxis()->SetRangeUser(.0, 2.0);
    s->SetMaximum(500000.);
  }else if(type == "RSQ" ){
    //RATIO = new TH1F("RATIO", fname + "_" + type , BaseDM::RSQ_Bins, BaseDM::RSQ_BinArr);
    RATIO = new TH1F("RATIO", fname + "_" + type , 20, 0.5, 2.0);
    label = "R^{2}";
    ...
    RATIO->GetXaxis()->SetRangeUser(0.5, 2.0);
    RATIO->GetYaxis()->SetRangeUser(.0, 2.0);
    s->SetMaximum(100000.);
  }else if(type == "MET"){
    ...
    RATIO = new TH1F("RATIO", fname + "_" + type , 20, 80.0, 100.0); 
    //RATIO = new TH1F("RATIO", fname + "_" + type , 50, 0.0, 200.0);
    label = "M_{#mu#mu}";
    s->SetMaximum(5.0e3);
  }else if(type=="Angle"){
    ...
    RATIO = new TH1F("RATIO", fname + "_" + type , 20, 80, 1500);
    label = "P^{J}_{T}";
    s->SetMaximum(3e4);
  }else if(type=="Eta_J"){
    ...
    RATIO = new TH1F("RATIO", fname + "_" + type , 20, 0, 1500.0);
    label = "P^{#mu}_{T}";
    s->SetMaximum(3e4);
  }else if(type=="Eta_mu"){
  ...
  TString n3 = "#int L dt = 18.84 fb^{-1}";
